...
void applicationStartup(struct Account accounts[], int size)
{
    ...
    do
    {
        ...
        {
            menuAgent(accounts, size, accounts[ans]);
        }
...
{
    int ans = -1, i=0, index=-1, acc=0, output=0;
    char ans2;
    do
    {
